...
/* helton.nogueira - license server - Defini��o do handle */
/*DEFINE NEW SHARED VARIABLE h-Btb432za        AS HANDLE    NO-UNDO.*/

/* luciano.araujo - 2011.09.22 - License Server: defini��o da procedure piConsome e de vari�veis relacionadas */
/*{ web/btb/wbtb432za.i }*/
/************************************************************
Temp-table: API login integra��o - License Server
************************************************************/
...
ON "WEB-NOTIFY":U ANYWHERE DO:
  ...
  RUN run-web-object IN web-utilities-hdl (AppProgram) NO-ERROR. 
    /* luciano.araujo - 2011.09.22 - License Server: efetua o consumo da licen�a */
    /*RUN piConsomeLightI. */   
...
/* helton.nogueira - License Server: instancia o programa de comunicacao com o LC/LS */
/*RUN btb/btb432za.p Persistent Set h-btb432za.*/
/*FOR EACH tt-erros: DELETE tt-erros. END.*/

/**UN btb/btapi910za.p (input "integra", INPUT "integra", output table tt-erros) NO-ERROR.
IF CAN-FIND(FIRST tt-erros) THEN DO:
   FOR EACH tt-erros: MESSAGE "|ERROS API DE LOGIN......: " + tt-erros.desc-erro. END.
END.*/
